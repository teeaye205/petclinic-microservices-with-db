...
resource "aws_iam_instance_profile" "profile_for_master_k8" {
  name  = var.profile_for_master_k8
  role = aws_iam_role.role_for_master.name
}

resource "aws_iam_instance_profile" "profile_for_worker_k8" {
  name  = var.profile_for_worker_k8
  role = aws_iam_role.role_for_worker.name
}

output master_profile_name {
  value       = aws_iam_instance_profile.profile_for_master_k8.name
}

output worker_profile_name {
  value       = aws_iam_instance_profile.profile_for_worker_k8.name
}